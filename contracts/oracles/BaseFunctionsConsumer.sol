...
contract BaseFunctionsConsumer is FunctionsClient, AutomationCompatible, WithSettler {
    ...
    function initializeConsumer(address _initOwner, address _router) public virtual initializer {
        _initializeConsumer(_initOwner, _router);
    }

    function _initializeConsumer(address _initOwner, address _router) internal virtual {
        ...
        emit InitializedConsumer(_router);
    }
