...
contract AGTPriceFeed is AGTReserveFeed {
    ...
    function initializeAGTPriceFeed(InitParams calldata params) public initializer {
        ...
        setUpkeep(
            ...
            params.upkeepInterval,
            params.upkeepRateInterval,
            params.upkeepRateCap,
            params.maxBaseGasPrice
        );
