...
export interface AGTPriceFeedInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "initializeAGTPriceFeed",
    values: [
      AddressLike,
      AddressLike,
      string,
  ...
  encodeFunctionData(
    functionFragment: "initializeAGTReserveFeed",
    values: [
      AddressLike,
      AddressLike,
      string,
...
export interface AGTPriceFeed extends BaseContract {
  ...
  getFunction(
    nameOrSignature: "initializeAGTPriceFeed",
  ): TypedContractMethod<
    [
      _initOwner: AddressLike,
      _asset: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "initializeAGTReserveFeed",
  ): TypedContractMethod<
    [
      _initOwner: AddressLike,
      _asset: AddressLike,
