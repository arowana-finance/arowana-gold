...
encodeFunctionData(functionFragment: 'changeDescription', values: [string]): string;
encodeFunctionData(functionFragment: 'implementation', values?: undefined): string;
encodeFunctionData(functionFragment: 'initializeProxy', values: [string, AddressLike, AddressLike, BytesLike]): string;
...
decodeFunctionResult(functionFragment: 'upgradeToAndCall', data: BytesLike): Result;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    initializeProxy: TypedContractMethod<
      [_description: string, newAdmin: AddressLike, newImplementation: AddressLike, data: BytesLike, ],
      [void],
      'payable'
    >
