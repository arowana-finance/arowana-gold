...
encodeFunctionData(functionFragment: 'callAsset', values: [AddressLike]): string;
...
encodeFunctionData(functionFragment: 'proposeAggregator', values: [AddressLike]): string;
...
decodeFunctionResult(functionFragment: 'version', data: BytesLike): Result;
    ...
    export namespace FeedConfirmedEvent {
      export type InputTuple = [asset: AddressLike, denomination: AddressLike, latestAggregator: AddressLike, previousAggregator: AddressLike, nextPhaseId: BigNumberish, sender: AddressLike];
      export type OutputTuple = [asset: string, denomination: string, latestAggregator: string, previousAggregator: string, nextPhaseId: bigint, sender: string];
      export interface OutputObject {asset: string, denomination: string, latestAggregator: string, previousAggregator: string, nextPhaseId: bigint, sender: string };
    ...
    export namespace FeedProposedEvent {
      export type InputTuple = [asset: AddressLike, denomination: AddressLike, proposedAggregator: AddressLike, currentAggregator: AddressLike, sender: AddressLike];
      export type OutputTuple = [asset: string, denomination: string, proposedAggregator: string, currentAggregator: string, sender: string];
      export interface OutputObject {asset: string, denomination: string, proposedAggregator: string, currentAggregator: string, sender: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
